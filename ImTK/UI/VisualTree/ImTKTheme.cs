        ...
        public static ImTKTheme DefaultDark
        {
            get
            {
                if (s_defaultDark == null)
                {
                    ...
                    s_defaultDark.normalColor.componentHover = new Color(0.22f, 0.22f, 0.22f, 1.0f);
                    s_defaultDark.normalColor.componentActive = new Color(0.10f, 0.10f, 0.10f, 1.0f);
                    ...
                    s_defaultDark.normalColor.selection = new Color(0.04f, 0.28f, 0.44f, 1.0f); // #094771
        ...
        public static ImTKTheme DefaultLight
        {
            get
            {
                if (s_defaultLight == null)
                {
                    ...
                    s_defaultLight.normalColor.componentHover = new Color(0.83f, 0.83f, 0.83f, 1.0f);
                    s_defaultLight.normalColor.componentActive = new Color(0.53f, 0.53f, 0.53f, 1.0f);
                    ...
                    s_defaultLight.normalColor.selection = new Color(0.55f, 0.75f, 0.95f, 1.0f);
